...
{% include video id="4L4-iqrPZfQ" provider="youtube" %}
### Cornel Simanjuntak
{% include video id="F8URANnV4Qw" provider="youtube" %}
### Nurcholish Madjid
{% include video id="cdC9hDeKKik" provider="youtube" %}
### Sulianti Saroso
{% include video id="M5q9zk74NOk" provider="youtube" %}
### Ciputra
{% include video id="GxjFEWH35bE" provider="youtube" %}
