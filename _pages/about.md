...
header:
  overlay_image: /assets/images/banner/lee-h-banner.webp
  overlay_filter: 0.36
author_profile: true
---

![ip-modular_lo-s]({{ site.url }}{{ site.baseurl }}/assets/images/ip/ip-modular_lo-s.webp){: .align-center}
...
![ip-circlelight2]({{ site.url }}{{ site.baseurl }}/assets/images/ip/ip-mic-bench2.webp)
...
![ip-modular-pose1]({{ site.url }}{{ site.baseurl }}/assets/images/ip/ip-modular-pose1.webp)
